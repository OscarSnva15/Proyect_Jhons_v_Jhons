        ...
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-xl-12 col-xl-12 col-xl-12 col-12 layout-spacing">
                <div class="widget widget-three">
                    <h3 class="text-primary mt-2 mb-4">Johnson & Johnson</h3>
                    <div class="widget-content">
                        <div class="card border-info mb-5">
                            <div class="card-header bg-info">
                                <div class="row">
                                    <div class="col-x3-12 mx-auto">
                                        <div class="element-background">
                                            <h4  class="text-white">CUESTIONARIO DE PERFIL DE SALUD</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <form id="atprimaria_perfilsaludform">
                                                ...
                                                <div class="container">
                                                    ...
                                                    <div class="row mt-4">
                                                        <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                                            <label for="fecha" class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">NOMBRE:</label>
                                                        ...
                                                        <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                                                            <label for="fecha" class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">EDAD:</label>
                                                        ...
                                                        <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                                                            <label for="fecha" class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">WWID:</label>
                                                    ...
                                                    <div class="row mt-4">
                                                        ...
                                                        <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                                                            ...
                                                            <input id="atprimaria_perfilsalud_fecha1" name="atprimaria_perfilsalud_fecha1" class="form-control flatpickr flatpickr-input" type="text" placeholder="Select Fecha..">
                                                            <script>
                                                        ...
                                                        <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 border-top border-right">
                                                            ...
                                                            <div class="row mb-4">
                                                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 border-top">
                                                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                        <label for="fecha" class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">Escala de 0% - 50% - 100%</label>
                                                    ...
                                                    <div class="row mt-4">
                                                        ...
                                                        <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                                            ...
                                                            <input class="fecha form-control flatpickr flatpickr-input active" type="date" placeholder="Seleccione una fecha..." id="atprimaria_perfilsalud_fecha2" name="atprimaria_perfilsalud_fecha2">
                                                            <script>
...
const form = document.getElementById('atprimaria_perfilsaludform');
