...
let input_seleccion_consulta_formato = document.querySelector('#input_seleccion_formato_atprimaria');
    ...
    dato = {id: id_formato}
    controller = `atprimaria/consultar_atencion_primaria`;
...
// function obtener_plantilla_atprimaria(objeto_json_formato_atprimaria){
//     console.log(
//         "hola"
//     )
//     console.log(objeto_json_formato_atprimaria.data[0].atprimaria_perfilsalud_nombre);
// }

// Funcion encargada de recibir los datos e imprimir el formulario del formato de SOA del pvm
                            ...
                            <div class="container">
                                ...
                                <div class="row  border-bottom mt-4">
                                    ...
                                    <div class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2">
                                        <div class="n-chk">
                                            <label class="new-control new-radio radio-info">
                                                <input type="radio" class="new-control-input" value="ENDO"  id="atprimaria_perfilsalud_check1A" name="atprimaria_perfilsalud_check1" value="${form_data[0].atprimaria_perfilsalud_check1}" readonly>
                                    ...
                                    <div class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2">
                                        <div class="n-chk">
                                            <label class="new-control new-radio radio-info">
                                                <input type="radio" class="new-control-input" value="INC"  id="atprimaria_perfilsalud_check1B" name="atprimaria_perfilsalud_check1 value="${form_data[0].atprimaria_perfilsalud_check1}" readonly">
